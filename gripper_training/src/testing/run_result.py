...
import ur5_gripper_env_testing
...
if __name__ == '__main__':
    ...
    Epsilon = 0 #rospy.get_param("/epsilon")
    ...
    for x in range(nepisodes):
        ...
        for i in range(nsteps):
            ...
            if done == "success_down":
                ...
                arm_group.set_named_target("place_cup_upright")
